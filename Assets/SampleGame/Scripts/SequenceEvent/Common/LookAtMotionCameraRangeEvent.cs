...
namespace SampleGame.SequenceEvents {
    /// <summary>
    /// LookAtMotionCamera切り替え再生イベント
    /// </summary>
    public class LookAtMotionCameraRangeEvent : RangeSequenceEvent {
        // ブレンド情報
        [Serializable]
        public struct Blend {
        ...
        [Header("アニメーション情報")]
        [Tooltip("アニメーション設定")]
        public LookAtMotionCameraComponent.Context context;
        [Tooltip("カメラIndex")]
    ...
    /// イベントハンドラ
    /// </summary>
    public class LookAtMotionCameraRangeEventHandler : RangeSequenceEventHandler<LookAtMotionCameraRangeEvent> {
        ...
        /// 開始時処理
        /// </summary>
        protected override void OnEnter(LookAtMotionCameraRangeEvent sequenceEvent) {
            if (_cameraManager != null) {
                var component = _cameraManager.GetCameraComponent<LookAtMotionCameraComponent>(sequenceEvent.cameraName);
                if (component != null) {
                    var rootPos = _root != null ? _root.position : Vector3.zero;
                    var rootRot = _root != null ? _root.rotation : Quaternion.identity;
                    component.Setup(sequenceEvent.context, sequenceEvent.slotIndex, sequenceEvent.startTime, rootPos, rootRot, _layeredTime);
                }
        ...
        /// 終了時処理
        /// </summary>
        protected override void OnExit(LookAtMotionCameraRangeEvent sequenceEvent) {
            if (_cameraManager != null) {
        ...
        /// キャンセル時処理
        /// </summary>
        protected override void OnCancel(LookAtMotionCameraRangeEvent sequenceEvent) {

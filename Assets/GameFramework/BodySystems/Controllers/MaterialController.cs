...
namespace GameFramework.BodySystems {
    ...
    public class MaterialController : BodyController {
        ...
        public struct MaterialHandle {
            ...
            /// </summary>
            private static void SetValue<T>(MaterialInfo info, int nameId, T val,
            ...
            /// </summary>
            private static T GetValue<T>(MaterialInfo info, int nameId,
        ...
        private void CreateMaterialInfos() {
            ...
            for (var i = 0; i < partsList.Length; i++) {
                ...
                for (var j = 0; j < parts.infos.Length; j++) {
                    ...
                    if (foundIndex < 0) {
                        Debug.LogWarning(
                            $"Not found material. {Body.GameObject.name}:{info.renderer.name}.{info.material.name}");
                        continue;
                    }

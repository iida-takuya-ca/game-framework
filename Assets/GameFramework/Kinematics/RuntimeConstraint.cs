...
namespace GameFramework.Kinematics {
    ...
    /// </summary>
    [ExecuteAlways]
    public abstract class RuntimeConstraint : IConstraint {
        // ターゲット元情報
        ...
        protected RuntimeConstraint(Transform owner, string targetName = "") {
            Owner = owner;
        ...
        protected RuntimeConstraint(Transform owner, Transform target)
